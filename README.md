...
- サイトタイトル（line 8）- 注：現在「portforio」となっていますが「portfolio」のスペルミスの可能性があります
- メタディスクリプション（line 10）- 注：現在「フォートフォリオ」となっていますが「ポートフォリオ」の誤字の可能性があります
- プロフィール情報（line 68-76）
...
WORKセクション（line 87-97）内の作品画像とタイトルを編集して、独自のポートフォリオ作品を追加できます。
